...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      dev: {
        files: {
          'css/explore-tool.css': [
		    'less/explore-tool.less'
          ]
        },
        options: {
          compress: false
    ...
    uglify: {
      dist: {
        files: {
          'js/explore-tool.min.js': [jsFileList]
        }
      }
    },
    ...
    postcss:{  
		...
		dev: {
			...
			src: 'css/explore-tool.css'
		},
		build: {
			src: 'css/explore-tool.min.css'
		}
	},
